export const readingQuestions = [
    // First passage
    {
        ...
        [4] Western settlement and the opening of the northern resource frontier stimulated industrial expansion, particularly in central Canada. As the National Policy had intended, a growing agricultural population in the West increased the demand for eastern manufactured goods, thereby giving rise to agricultural implements works, iron and steel foundries, machine shops, railway yards, textile mills, boot and shoe factories, and numerous smaller manufacturing enterprises that supplied consumer goods. By keeping out lower-priced foreign manufactured goods, the high tariff policies of the federfll government received much credit kit protecting existing industries and encouraging the creation of new enterprises. To climb the tariff wall, large American industrial firms opened branches in Canada, and the governments of Ontario and Quebec aggressively urged them on by offering bonuses, subsidies, and guarantees to locate new plants within their borders. Canadian industrial enterprises became increasingly attractive to foreign investors, especially from the United States and Great Britain. Much of the over $600 million of American capital that flowed into Canada from 1900 to 1913 was earmarked for mining and the pulp and paper industry, while British investors contributed near $1.8 bil- lion, mostly in railway building, business development, and the construction of urban infrastructure. As a result, the gross value of Canadian manufactured products quadrupled from 1891 to 1916.
        `,
