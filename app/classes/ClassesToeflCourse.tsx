...
const ongoingSeries: Series[] = [
  ...
  { id: 4, title: 'Series 4', image: 'https://www.dropbox.com/scl/fi/kynj1hfv0c9ud4d5td0sf/toefl_speaking_class.png?rlkey=nh3710572rilon3ybaxeyb8w8&st=mtr8jnmm&raw=1' },
]
...
const SeriesGrid = ({ series }: { series: Series[] }) => (
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    {series.map((item) => (
      <Link key={item.id} href={`/courses/toefl-course`} className="block" aria-label={`Go to ${item.title}`}>
