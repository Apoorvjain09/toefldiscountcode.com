...
import { usUniversities, countryCodes } from '@/app/university-shortlisting/UniversitiesList';
...
const UniversityShortlistingModal: React.FC<UniversityShortlistingModalProps> = ({ isOpen, onClose, onComplete }) => {
  ...
  const countries = ["USA", "UK", "Canada", "Australia", "Germany", "France", "India"] as const;
  ...
  const partnerUniversities: Record<Country, string[]> = {
    ...
    France: ["Sorbonne University", "École Polytechnique", "University of Paris"],
    India: ["IIT Bombay", "IIT Delhi", "IIT Madras"]
  };
