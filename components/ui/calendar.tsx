  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "border shadow-sm bg-gray-50 text-slate-50 hover:bg-gray-300 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
