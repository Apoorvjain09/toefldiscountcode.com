...
export default function payemnt() {
    return (
        <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            <h1 className="text-4xl font-extrabold leading-none tracking-tight md:text-5xl text-gray-900 mb-20 text-center"><span className='bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 text-transparent bg-clip-text uppercase'>Subscriptions</span></h1><div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
                ...
                <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
                    <div className="p-6 sm:px-8">
                        ...
                        <p className="mt-2 text-gray-700">For Users Whoose test date are close.</p>
